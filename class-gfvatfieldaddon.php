...
class GFVatFieldAddOn extends GFAddOn {
	...
	public function tooltips( $tooltips ) {
		$vat_tooltips = array(
			'input_class_setting' => sprintf( '<h6>%s</h6>%s', esc_html__( 'Input CSS Classes', 'vatfieldaddon' ), esc_html__( 'The CSS Class names to be added to the field input.', 'vatfieldaddon' ) ),
		);

		return array_merge( $tooltips, $vat_tooltips );
	}
